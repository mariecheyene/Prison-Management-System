        ...
        <Form onSubmit={handleSubmit}>
          <Modal.Body style={{ maxHeight: '70vh', overflowY: 'auto' }}>
            <Alert variant="info" className="mb-3">
              <strong>Male Division:</strong> Visitors can only be connected to male inmates.
            </Alert>
              ...
              <Col md={6}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    required
                    placeholder="Enter male prisoner ID"
                  />
                  <Form.Text className="text-muted">
                    Only male inmates available for selection
                  </Form.Text>
            ...
            <Alert variant="info" className="mt-3">
              ...
              Visitors can only be connected to male inmates in this division.
            </Alert>
          </Modal.Body>
          <Modal.Footer>
        ...
        <Modal.Body>
          <Form.Group>
            ...
            <Form.Text className="text-muted">
              ...
              <br />
              <strong>Note:</strong> Only male inmates are available in this division.
            </Form.Text>
          </Form.Group>
        </Modal.Body>
        <Modal.Footer>
