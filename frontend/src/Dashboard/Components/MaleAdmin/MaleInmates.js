...
const Inmates = ({ gender = 'all' }) => {
 ...
 const handleSubmit = async (e) => {
  ...
  const exportToCSV = () => {
    ...
    toast.success(`Exported ${inmates.length} inmates to CSV`);
  };
  ...
  const getGenderTitle = () => {
    switch (selectedGender) {
      case 'male': return 'Male Inmates Management';
      case 'female': return 'Female Inmates Management';
      default: return 'All Inmates Management';
    }
  };
    ...
    <Container>
          ...
          <Row className="align-items-center">
            <Col md={6}>
              <div className="d-flex gap-2 align-items-center">
                <span className="fw-bold me-2">Filter by Gender:</span>
                <ButtonGroup>
                  <Button
          ...
          <Row className="mt-2">
            <Col>
              <div className="text-muted small">
                Showing {filteredInmates.length} inmates 
      ...
      {isLoading && inmates.length === 0 ? (
        <div className="text-center">
          <Spinner animation="border" role="status">
            <span className="visually-hidden">Loading inmates...</span>
          </Spinner>
        </div>
        ...
        <Alert variant="info">
          {searchQuery || selectedGender !== 'all' 
            ...
            : 'No inmates found. Add your first inmate to get started.'}
        </Alert>
      ) : (
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} size="xl">
        <Modal.Header closeButton>
          <Modal.Title>{editingInmate ? 'Edit Inmate' : 'Add New Inmate'}</Modal.Title>
        </Modal.Header>
