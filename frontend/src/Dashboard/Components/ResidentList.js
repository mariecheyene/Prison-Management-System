...
const ResidentList = () => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const formattedBirthdate = formatDate(selectedResident.birthdate);
                    ...
                    <tr key={resident.id}>
                      ...
                      <td>
                        <ButtonGroup>
                          ...
                          <Button variant="warning" size="sm" className="me-1" onClick={() => handleEditResident(resident)}>
                            Edit
                          </Button>
                          <Button variant="success" size="sm" className="me-1" onClick={() => handleGenerateQrCode(resident.id)}>
                            <FaQrcode />
                          </Button>
                          <Button variant="danger" size="sm" onClick={() => handleDeleteResident(resident.id)}>
                            Delete
                          </Button>
                        </ButtonGroup>
                      </td>
            ...
            <Form onSubmit={handleEditSubmit}>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="date"
                  name="birthdate"
                  value={formatDate(selectedResident.birthdate)}
